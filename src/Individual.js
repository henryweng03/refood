...
// interface for public users (aka individuals) to sign up for events
...
export default function Individual() {
  ...
  // handle open and close of sign up pop-up view
  ...
  // state for submission of sign up
          ...
          {selectedMarker ? (
            ...
            >
              <div>
                ...
                <button className="signup-button" onClick={handleSignUpOpen}>
                  Sign Up
                </button>
                <Dialog
                  open={open}
                ...
                >
                  <div class="sign-form">
                    ...
                    >
                      <div class="field">
                        <input type="text" required {...register("fname")} />
                        <br />
                        <br />
                        <label>First Name</label>
                      </div>
                      <div class="field">
                        <input type="text" required {...register("lname")} />
                        <br />
                        <br />
