...
// interface for stores and restaurants to create new events and view sign ups

// intialize map defaults
...
export default function StoreApp() {
  ...
  // read in marker data from the firebase database
  useEffect(() => {
  ...
  // push the form data to firebase upon submission
  const onSubmit = (data) => {
    ...
    // add event submission marker to maps
          ...
          <tbody>
            {signUps.map((signup) => (
              <tr>
                ...
                <td>
                  {signup.data.fname} {signup.data.lname}
                </td>
